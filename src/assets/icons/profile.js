...
export function ProfileIcon(props) {
  return (
    <Svg width="13" height="16" viewBox="0 0 13 16" fill="none" xmlns="http://www.w3.org/2000/Svg">
        <Path d="M6.39767 10.5391C2.94724 10.5391 0 11.0831 0 13.2591C0 15.4359 2.92884 15.9991 6.39767 15.9991C9.84811 15.9991 12.7953 15.4559 12.7953 13.2791C12.7953 11.1023 9.8673 10.5391 6.39767 10.5391Z" fill="black"/>
